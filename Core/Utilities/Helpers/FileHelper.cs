...
namespace Core.Utilities.Helper
{
    public class FileHelper
    {
        ...
        {
            var fileExists = ChechkFileExists(file);
            ...
            var typeValid = CheckFilleTypeValid(type);
        ...
        private static IResult ChechkFileExists(IFormFile file)
        {
        ...
        private static IResult CheckFilleTypeValid(string type)
        {
            if (type != ".jpeg" && type != ".png" && type != ".jpg")
            {
                return new ErrorResult("Yanlış dosya uzantısı.");
            }
            return new SuccessResult();
        }
